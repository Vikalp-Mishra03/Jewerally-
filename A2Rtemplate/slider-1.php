                ...
                <section class="slider-area">
                    <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
                        ...
                        <div class="hero-single-slide hero-overlay">
                            <div class="hero-slider-item bg-img" style="background-image: url(assets/images/slider/home1-slide2.webp);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <!-- single slider item start -->
                        <div class="hero-single-slide hero-overlay">
                            <div class="hero-slider-item bg-img" style="background-image: url(assets/images/slider/home1-slide3.webp);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <!-- single slider item start -->
                        <div class="hero-single-slide hero-overlay">
                            <div class="hero-slider-item bg-img" style="background-image: url(assets/images/slider/home1-slide1.webp);">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
